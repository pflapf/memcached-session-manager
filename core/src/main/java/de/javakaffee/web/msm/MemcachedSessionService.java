...
public class MemcachedSessionService {
    ...
    void startInternal() throws LifecycleException {
        ...
        _trackingHostValve = createRequestTrackingHostValve(sessionCookieName);
    ...
    protected RequestTrackingHostValve createRequestTrackingHostValve(final String sessionCookieName) {
        return new RequestTrackingHostValve(_requestUriIgnorePattern, sessionCookieName, this, _statistics, _enabled);
    }
